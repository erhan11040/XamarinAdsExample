...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MarcTron.Plugin.Listener.MyAdBannerListener, Plugin.MtAdmob", MyAdBannerListener.class, __md_methods);
	}
	...
	public MyAdBannerListener ()
	{
		...
		if (getClass () == MyAdBannerListener.class)
			mono.android.TypeManager.Activate ("MarcTron.Plugin.Listener.MyAdBannerListener, Plugin.MtAdmob", "", this, new java.lang.Object[] {  });
	}
